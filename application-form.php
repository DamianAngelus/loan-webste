...
<html lang="zxx">
<head>
	<title>Education Loan Management System::Application Form</title>
...
{               ?>
					 ...
					 <option value="Voted ID">Voter ID</option>
					 ...
					 <p><label style="font-size: 18px;padding-top: 20px;">Degree Type(UG/PG/International):</label>
					 ...
					 <option value="">Choose</option>
					 <option value="10 yrs">2 yrs</option>
					 <option value="12 yrs">3 yrs</option>
					 <option value="14 yrs">4 yrs</option>
					 <option value="15 yrs">6 yrs</option>
					 <option value="16 yrs">8 yrs</option>
					  <option value="18 yrs">10 yrs</option>
					   <option value="20 yrs">12 yrs</option></select></p>
