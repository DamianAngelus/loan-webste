...
echo "<script>alert('Congraluations Successfully Registered');</script>";
}
else
{
...
<html lang="zxx">
<head>
	<title>Education Loan Management System::Sign Up Page</title>
...
<body>
	...
	<section class="contact py-5">
		<div class="container py-md-4 mt-md-3">
			<h2 class="heading-agileinfo">Registration!!<span>Speed Up The Loan Process</span></h2>
